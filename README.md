...
- `browser-extension-agent_safe.eide` — the correct design.
- `browser-extension-agent_unsafe.eide` — the tempting-but-wrong version (the negative example a model must learn to reject).
